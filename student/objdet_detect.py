...
def load_configs_model(model_name='darknet', configs=None):
    ...
    if model_name == "darknet":
        ...
        parser.add_argument('-a', '--arch', type=str, default='fpn_resnet', metavar='ARCH',
                            help='The name of the model architecture')
        parser.add_argument('--pretrained_filename', type=str,
                            default='tools/objdet_models/resnet/pretrained/fpn_resnet_18_epoch_300.pth', metavar='PATH',
